...
if __name__ == "__main__":
    ...
    if sim.open()==0:
        ...
        mock = Mock()
        mock.add_listened_parameter("ZULU TIME","s",None,None,1,1,1000000,False)
        mock.add_listened_parameter("Plane Latitude","°",None,None,40,40,60)
        mock.add_listened_parameter("Plane Longitude","°",None,None,0,0,10)
        mock.add_listened_parameter("Plane Altitude","ft",None,None,1000,1000,2000)
        mock.add_listened_parameter("Plane Bank Degrees","°",None,None,-60,-60,60)
        mock.add_listened_parameter("Plane Pitch Degrees","°",None,None,-20,-20,20)
        mock.add_listened_parameter("Plane Heading Degrees True","°",None,None,10,10,355)        
        mock.open()
